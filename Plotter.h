...
namespace AnoraksMath
{
	...
	public:
		...
		void addfun(long double(*fun)(vector<long double>,vector<long double>,long double),vector<long double>xv,vector<long double>fv,long double x0, long double x1);
		void clear();
